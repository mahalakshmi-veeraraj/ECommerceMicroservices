package com.maha.ecommerce.user_service.security;
...
//		By default, all the requests to this application require authentication.
//		If a user is not authenticated, they will be redirected to the login page
//		configured by the formLogin() method.
...
//				.password("$2a$12$6E0u1L28DKfCUOsJFA9VceB1X55AupDQmJnAYVffHeSU2n.V9.atq").roles("USER").build();
//
...
//				.clientSecret("$2a$12$wQ8KUuYIhbwTorKmyzp2sug.atoam9r0IWR098N7/bSSlsjgnjb1O")
...
//	}
	...
	// To add roles into JWT token claims section.
	@Bean
		...
		return (context) -> {
			if (OAuth2TokenType.ACCESS_TOKEN.equals(context.getTokenType())) {
				context.getClaims().claims((claims) -> {
					...
					// Adding extra information into the claims.
