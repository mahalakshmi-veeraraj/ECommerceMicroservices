...
public class RazorpayPaymentGateway implements PaymentGateway {
	...
	public String generatePaymentLink(Long id, Long amount) throws RazorpayException {
		...
		// front end ui application will need to use this short_url to allow the client
		// to pay.
		// once the payment is completed either success or failure the call back url
		// application
		// will back to the original client application and which will be happen through
		// 'callbackUrl' value in the payment object.
